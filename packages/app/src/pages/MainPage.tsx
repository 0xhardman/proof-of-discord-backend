...
import {
  generateDiscordVerifierCircuitInputs,
  IDiscordCircuitInputs,
} from "@proof-of-discord/circuits/helpers";
    ...
    <Container>
      ...
      >
        <span style={{ color: "rgba(255, 255, 255, 0.7)" }}>
          ...
          <a href="https://prove.email/blog/discord">here</a>. 
          <br />
          <br />
        ...
        <NumberedStep step={1}>
          Send yourself a{" "}
          <a
            href="https://discord.com/account/begin_password_reset"
            target="_blank"
            rel="noreferrer"
          >
            password reset email
          </a>{" "}
          from Discord. (Reminder: Discord name with emoji might fail to pass DKIM verification)
        </NumberedStep>
        <NumberedStep step={2}>
        ...
        <NumberedStep step={5}>
          ...
          <a href="https://github.com/zkemail/proof-of-discord/" target="_blank" rel="noreferrer">open source</a>, 
          and no server ever sees your private information.
        </NumberedStep>
        <NumberedStep step={6}>
          Click <b>"Verify"</b> and then <b>"Mint Discord Badge On-Chain"</b>,
          and approve to mint the NFT badge that proves Discord ownership! Note
        ...
        <Column>
          ...
          <Button
            ...
            onClick={async () => {
              ...
              let input: IDiscordCircuitInputs;
              try {
                setDisplayMessage("Generating proof...");
                setStatus("generating-input");

                input = await generateDiscordVerifierCircuitInputs(emailBuffer, ethereumAddress);
