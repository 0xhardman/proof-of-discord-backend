...
contract Deploy is Script, Test {
    ...
    function run() public {
        ...
        // discord.com hash for selector dkim-202308
        ...
        ProofOfDiscord testVerifier = new ProofOfDiscord(proofVerifier, dkimRegistry);
        console.log("Deployed ProofOfDiscord at address: %s", address(testVerifier));
